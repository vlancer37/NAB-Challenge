...
### 2. Package diagram:
  ...
  - A Microservice project will be divided into many Maven modules:
    * The application module includes:
      ...
      + port.in package, that contains all of the interfaces for the [use-cases](https://github.com/vlancer37/NAB-Challenge#iv-use-case-diagram-for-store-microservice) that we have
